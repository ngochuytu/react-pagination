...
var Pagination = function (props) {
    ...
    totalPages = React.useMemo(function () { return Math.round(Math.abs(totalPages)); }, [totalPages]);
    activePage = React.useMemo(function () { return Math.round(Math.abs(activePage)); }, [activePage]);
    pageRange = React.useMemo(function () { return Math.round(Math.abs(pageRange)); }, [pageRange]);
    breakButtonStep = React.useMemo(function () { return Math.round(Math.abs(breakButtonStep)); }, [breakButtonStep]);
    var _b = React.useState(activePage), currentPage = _b[0], setCurrentPage = _b[1];
    ...
    var generatePaginationButton = React.useCallback(function (key, label, className, onClick) {
        return (React__default["default"].createElement("div", { key: key, className: className, onClick: onClick }, label));
    }, []);
    var navigateToFirstPageButton = React.useMemo(function () {
    ...
    var navigateToLastPageButton = React.useMemo(function () {
    ...
    var firstPageButton = React.useMemo(function () { return generatePaginationButton('first-page', 1, pageButtonClassName, function () { return setCurrentPage(1); }); }, [pageButtonClassName, generatePaginationButton]);
    var lastPageButton = React.useMemo(function () { return generatePaginationButton('last-page', totalPages, pageButtonClassName, function () { return setCurrentPage(totalPages); }); }, [pageButtonClassName, generatePaginationButton, totalPages]);
    var previousBreakButton = React.useMemo(function () {
    ...
    var nextBreakButton = React.useMemo(function () {
    ...
    var pageNumberButton = React.useCallback(function (pageNumber) {
    ...
    var renderPagination = React.useCallback(function () {
        var pagination = [];
        //3 Stages:
    ...
    return React__default["default"].createElement("div", { className: containerClassName }, renderPagination());
};
